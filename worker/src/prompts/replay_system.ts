// AUTOGENERATED / HAND-MAINTAINED MIRROR of `replay_system.md`.
// KEEP IN SYNC. See `learn_system.ts` for why this duplication exists.

export const REPLAY_SYSTEM_PROMPT = `You drive a headless browser through ONE instance of a previously
